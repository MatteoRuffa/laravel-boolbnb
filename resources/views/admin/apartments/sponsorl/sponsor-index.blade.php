                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-12">
                                                <div class="content pt-1 pb-2 promotion-details text-end fw-bold">
                                                    ...
                                                    <p class=" fw-semibold fst-italic">{{ $promotion->title }} <span>{{ intval($promotion->duration) }}h</span></p>
                                                    <p class=" fw-light fst-italic">Expiration: {{ \Carbon\Carbon::parse($promotion->pivot->end_date)->format('d/m/Y') }} </p>
                                                    <span class="timer-box p-1 border-0" id="timer-{{ $apartment->id }}-{{ $promotion->id }}"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
